...
var wedgeColorA = '#16a085';
var wedgeColorB = '#2980b9';
var wedgeColorC = '#34495e';
var wedgeColorD = '#f39c12';
var wedgeColorE = '#d35400';
var wedgeColorF = '#c0392b';
var wedgeSubdiv;
...
function loop() {
  ...
  for (var i = 0; i < list_len; i++) {
    ...
    switch (i % 6) {
      ...
      case 3:
        ...
        break;
      case 4:
        fillColor(wedgeColorE);
        break;
      case 5:
        fillColor(wedgeColorF);
        break;
    }
  ...
  if (!nameList.length) {
    context.beginPath();
    context.textAlign = 'center';
    context.font = canvas.width / (is_mobile ? 18 : 24) + 'px Myriad Pro';
    fillColor('red');
